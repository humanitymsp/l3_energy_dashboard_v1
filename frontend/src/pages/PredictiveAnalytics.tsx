    ...
    <div className="space-y-6">
          ...
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-muted-foreground truncate">Critical Predictions</dt>
                  <dd className="text-3xl font-semibold text-foreground">{criticalPredictions.length}</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <div className="bg-card border border-border overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-muted-foreground truncate">Active Anomalies</dt>
                  <dd className="text-3xl font-semibold text-foreground">{activeAnomalies.length}</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <div className="bg-card border border-border overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-muted-foreground truncate">Actionable Insights</dt>
                  <dd className="text-3xl font-semibold text-foreground">{insights.filter(i => i.actionable).length}</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <div className="bg-card border border-border overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-muted-foreground truncate">Potential Savings</dt>
                  <dd className="text-3xl font-semibold text-foreground">$10K</dd>
                </dl>
              </div>
            </div>
          </div>
      ...
      <div className="bg-card border border-border shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h2 className="text-lg font-medium text-foreground mb-4">AI-Powered Insights</h2>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="mt-2 text-xs text-muted-foreground">{insight.details}</p>
      ...
      <div className="bg-card border border-border shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h2 className="text-lg font-medium text-foreground mb-4">Equipment Failure Predictions</h2>
            ...
            {predictions.map((pred) => (
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-2">
                      <h3 className="text-sm font-semibold text-foreground">{pred.equipmentName}</h3>
                      <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${
                        pred.prediction.failureRisk === 'critical'
                          ? 'bg-red-100 dark:bg-red-900/50 text-red-800 dark:text-red-300'
                          : pred.prediction.failureRisk === 'high'
                    ...
                    <div className="mt-3 grid grid-cols-3 gap-4 text-xs">
                      <div>
                        ...
                        <p className="font-semibold text-foreground">{pred.prediction.failureProbability}%</p>
                      </div>
                      <div>
                        <p className="text-muted-foreground">Est. Days to Failure</p>
                        <p className="font-semibold text-foreground">{pred.prediction.estimatedDaysToFailure}</p>
                      </div>
                      <div>
                        <p className="text-muted-foreground">Confidence</p>
                        <p className="font-semibold text-foreground">{pred.prediction.confidence}%</p>
                      </div>
                    </div>
      ...
      <div className="bg-card border border-border shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h2 className="text-lg font-medium text-foreground mb-4">Anomaly Detection</h2>
          <div className="space-y-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 grid grid-cols-3 gap-4 text-xs">
                      <div>
                        ...
                        <p className="font-semibold text-foreground">{anomaly.metrics.expected}</p>
                      </div>
                      <div>
                        <p className="text-muted-foreground">Actual</p>
                        <p className="font-semibold text-foreground">{anomaly.metrics.actual}</p>
                      </div>
                      <div>
      ...
      <div className="bg-card border border-border shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h2 className="text-lg font-medium text-foreground mb-4">Machine Learning Models</h2>
              ...
              >
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-foreground">{model.dataPoints.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Version</span>
                    <span className="font-semibold text-foreground">{model.version}</span>
                  </div>
