...
const mockProperties = [
  {
    ...
    // 48 units + 2 building mains = 50 Shelly EM devices
    // 48 units + 2 building mains = 50 Ecodirect sensors
    shelly_devices: 50,
  ...
  },
  {
    ...
    // 72 units + 3 building mains = 75 Shelly EM devices
    // 72 units + 3 building mains = 75 Ecodirect sensors
    shelly_devices: 75,
